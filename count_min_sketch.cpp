...
void CountMinSketch::update(int item, int c) {
  ...
  for (unsigned int j = 0; j < d; j++) {
    ...
    //hashval = hashval%w;
    //tmp1 = (((long)hashes[j][0]*item+hashes[j][1])%LONG_PRIME)%w;
    //cout << "hashval = "<<hashval << endl;
    //cout << "tmp1 = "<<tmp1 << endl;
    /*
    cout <<"hash["<<j<<"][0] = "<<hashes[j][0] <<endl;
    cout << "item = "<<item <<endl;
    cout << "hash["<<j<<"][1] = "<<hashes[j][1] <<endl;
    cout << "LONG_PRIME = " << LONG_PRIME <<endl;
    cout << "hashes[j][0]*item+hashes[j][1] = " << hashes[j][0]*item+hashes[j][1] << endl;
    cout << "(hashes[j][0]*item+hashes[j][1])\%LONG_PRIME = " << tmp <<endl;
    cout << "w = "<<w << endl;
    cout << "hashval = "<<hashval << endl;
    cout << C[j][hashval] <<endl;
    */
